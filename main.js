...
function showWeatherInfo(e) {
  ...
  fetch(
    "https://www.7timer.info/bin/api.pl?" +
      e.value +
      "&product=civillight&unit=metric&output=json"
  )
      ...
      data.dataseries.forEach((weather) => {
        ...
        resultDiv.innerHTML =
          ...
          `<div class="card-body">
                                ...
                                <p class="weather-temperatures">Max: ${
                                  weather.temp2m.max
                                } ºC</p>
                                <p class="weather-temperatures">Min: ${
                                  weather.temp2m.min
                                } ºC</p>
...
function formatDate(date) {
  ...
  return new Date(year, month - 1, currDate).toLocaleDateString("en-GB", {
    weekday: "short",
    month: "short",
    day: "numeric",
  });
